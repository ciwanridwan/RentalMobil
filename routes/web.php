...
// Raja Sewa Mobil
Route::get('cars-raja', 'RentalController@carsRaja')->name('cars-raja');
...
// Platinum rent car
Route::get('cars-platinum', 'RentalController@carsPlatinum')->name('cars-platinum');
...
// Bintangmas rent car
Route::get('cars-bintangmas', 'RentalController@carsBintangMas')->name('cars-bintangmas');
...
// Keken rent car
Route::get('cars-keken', 'RentalController@carsKeken')->name('cars-keken');
...
// Cakra rent car
Route::get('cars-cakra', 'RentalController@carsCakra')->name('cars-cakra');
...
// Artharent car
Route::get('cars-artharent', 'RentalController@carsArtharent')->name('cars-artharent');
