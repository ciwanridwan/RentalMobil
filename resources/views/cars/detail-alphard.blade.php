            ...
            <div class="container">
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        ...
                        </a> <span class="lnr lnr-arrow-right"></span> <a href="{{ route('cars-bintangmas')}}"> Bintangmas Rent Car</a></p>
                    </div>                                          
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-8 post-list blog-post-list">
                        <div class="single-post">
                            ...
                            <div class="content-wrap">
                                <p>
                                    Seputar info mobil Alphard dari Bintangmas Rent Car : <br>
                                    <ul>
                                        <li>1. Mobil : alphard </li>
                                        <li>2. Merk/Brand : Toyota</li>
                                        <li>3. Tahun : 2019</li>
                                        <li>4. Kilometer : 11.000 Km</li>
                                        <li>5. Harga Rental : Rp 30.000.000 / hari</li>
                                    </ul>
                                </p>
                    ...
                    <div class="col-lg-4 sidebar">
                        <div class="single-widget protfolio-widget">
                            <img src="img/bintangmas.jpg" class="img-fluid" alt="">
                            <a href="#"><h4>Bintangmas Rent Car</h4></a>
                            <p>
                                Mobil rental yang kami sediakan insyaallah buat anda nyaman.
                            </p>
                            <ul>
