            ...
            <div class="container">
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        ...
                        </a> <span class="lnr lnr-arrow-right"></span> <a href="{{ route('cars-cakra')}}"> Cakra Rental Mobil</a></p>
                    </div>                                          
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-8 post-list blog-post-list">
                        <div class="single-post">
                            ...
                            <div class="content-wrap">
                                <p>
                                    Seputar info mobil Fortuner dari Cakra Rental Mobil : <br>
                                    <ul>
                                        <li>1. Mobil : Fortuner </li>
                                        <li>2. Merk/Brand : Toyota</li>
                                        <li>3. Tahun : 2017</li>
                                        <li>4. Kilometer : 16.000 Km</li>
                    ...
                    <div class="col-lg-4 sidebar">
                        <div class="single-widget protfolio-widget">
                            <img src="img/cakracar.jpg" alt="" class="img-fluid">
                            <a href="#"><h4>Cakra Rental Mobil</h4></a>
                            <p>
                                Penyedia jasa sewa rental mobil terbaik se-indonesia.
                            </p>
                            <ul>
