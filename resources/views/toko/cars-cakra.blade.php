        ...
        <div class="row">
            <div class="col-lg-6 col-md-8">
                <div class="single-review">
                    ...
                    <a href="{{ route('detail-inova')}}">
                        <img src="img/mobil/inova.jpg" alt="inova" width="400px" class="img-fluid">
            ...
            <div class="col-lg-6 col-md-8">
                <div class="single-review">
                    ...
                    <a href="{{ route('detail-rush')}}">
                        <img src="img/mobil/rush.jpg" alt="rush" width="400px" class="img-fluid">
            ...
            <div class="col-lg-6 col-md-8">
                <div class="single-review">
                    ...
                    <a href="{{ route('detail-fortuner3')}}">
                        <img src="img/mobil/fortuner3.jpg" alt="fortuner3" width="400px" class="img-fluid">
