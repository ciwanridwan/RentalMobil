    ...
    <div class="container">
        <div class="row d-flex justify-content-center pb-40">
            <div class="col-md-8 pb-40 header-text">
                <h1 class="text-center pb-10">Keken Rent Car</h1>
                <p class="text-center">
        ...
        <div class="active-model-carusel">
            <div class="row align-items-center single-model item">
                <div class="col-lg-6 model-left">
                    ...
                    <br>
                    <a class="text-uppercase primary-btn" href="{{ route('detail-avanza')}}">Book This Car Now</a>
                </div>
            ...
            <div class="row align-items-center single-model item">
                <div class="col-lg-6 model-left">
                    ...
                    <br>
                    <a class="text-uppercase primary-btn" href="{{ route('detail-ertiga')}}">Book This Car Now</a>
                </div>

                <div class="col-lg-6 model-right">
                    <img class="img-fluid" src="img/mobil/ertiga.jpg" alt="">
                </div>
            </div>
            <div class="row align-items-center single-model item">
                <div class="col-lg-6 model-left">
                    <div class="title justify-content-between d-flex">
                        <h2 class="mt-20">Daihatsu Ayla</h2>
                    </div>
                    <h3>Rp 12,5juta/hari</h3>
                    <br>
                    <a class="text-uppercase primary-btn" href="{{ route('detail-ayla')}}">Book This Car Now</a>
                </div>

                <div class="col-lg-6 model-right">
                    <img class="img-fluid" src="img/mobil/ayla.jpg" alt="">
                </div>
            </div>                                              
        </div>
    </div>  
