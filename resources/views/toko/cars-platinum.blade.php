        ...
        <div class="row">
            <div class="col-lg-6 col-md-8">
                <div class="single-review">
                    ...
                    <a href="{{ route('detail-avanza2')}}">
                        <img src="img/mobil/avanza2.jpg" alt="avanza2" width="400px" class="img-fluid">
            ...
            <div class="col-lg-6 col-md-8">
                <div class="single-review">
                    ...
                    <a href="{{ route('detail-xenia')}}">
                        <img src="img/mobil/xenia.jpeg" alt="xenia" width="400px" class="img-fluid">
            ...
            <div class="col-lg-6 col-md-8">
                <div class="single-review">
                    ...
                    <a href="{{ route('detail-expander')}}">
                        <img src="img/mobil/expander.jpg" alt="expander" width="400px" class="img-fluid">
